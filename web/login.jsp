    ...
    <body>
                ...
                <div class="authentication-inner">
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <!-- /Logo -->
                            <h4 class="mb-2">Welcome to KRS! 👋</h4>
                            <p class="mb-4">Please sign-in to your account and start learning with out website</p>
                        ...
                        <div class="row mb-3"
                            ...
                            <span class="mb-3 text-center">Or login with</span>
        ...
        <script>
            function showPassword() {
                ...
                let iconElement = document.getElementById('showIcon');
