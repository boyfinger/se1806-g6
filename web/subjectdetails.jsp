...
<div class="row">
    ...
    <div class="col-lg-10">
        <h1><span class="badge badge-pill badge-primary">Subject details</span></h1>
        ...
        <form action="subjectdetails" method="post">
            ...
            <input type="hidden" name="status" value="${requestScope.subject.status}"/>
            <div class="form-group">
                <label for="code">Subject code</label>
                <input type="text" class="form-control" name="code" id="code" value="${requestScope.subject.code}"
                       placeholder="Subject code">
            </div>
            <div class="form-group">
                <label for="name">Subject name</label>
                <input type="text" class="form-control" name="name" id="name" value="${requestScope.subject.name}"
        ...
        <form action="lesson">
            ...
            <button type="submit" class="btn btn-primary">View lesson list</button>
        </form>
    </div>
    <div class="col-lg-1"></div>
</div>
